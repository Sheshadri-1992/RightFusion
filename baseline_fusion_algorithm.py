...
my_dict = {'depth_to_fusion_group_dict': {1: [['nsfw']], 2: [['image_annotation']],
           ...
           'resource_dict': {'nsfw': {'xeon': 2}, 'image_annotation': {'xeon': 1}, 'multi_image_resizing': {'xeon': 1},
                             'image_concatenation': {'xeon': 1}},
           'fusion_depth_list': [1, 2, 3], 'fusion_depth_index': 0, 'fusion_group': ['nsfw'],
           'layer': 'xeon'}

# my_dict = {'resource_dict': {'nsfw': {'xeon': 2}, 'image_annotation': {'xeon': 1}, 'multi_image_resizing': {'xeon': 1},
#                              'image_concatenation': {'xeon': 1}},
#            'fusion_group_dict': {1: [['nsfw']], 2: [['image_annotation']],
#                                  3: [['multi_image_resizing'], ['image_concatenation']]}}

# my_dict = {'resource_dict': {'spam': {'xeon': 1}, 'profanity': {'xeon': 1}, 'text_summarization': {'xeon': 1}},
#            'fusion_group_dict': {1: [['spam']], 2: [['profanity']],
#                                  3: [['text_summarization']]}}
