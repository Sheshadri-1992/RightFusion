...
def send_request_to_faas_controller(req_id: str, index: int):
    ...
    func_to_qos_dict = {"face_detection": {"qos_metric": 1500}, "image_resizing": {"qos_metric": 750},
                        "format_conversion": {"qos_metric": 2750}}

    application = constants.FACE_DETECTION_PIPELINE
    # application = constants.TEXT_INFERENCING
    starting_function = constants.FACE_DETECTION
    ...
    arg_request_dict = {"event_payload": "func_exec", "input_array": [], "input_size": input_size,
                        ...
                        "application": "face_detection_pipeline",
