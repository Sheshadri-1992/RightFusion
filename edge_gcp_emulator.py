...
class GCPEmulator:
    ...
    def put_data(self, arg_req_dict: dict) -> dict:
        ...
        print("[Edge Data Service] GCP Emulator put for reg id {0} Output Size {1}, Time {2}".
    ...
    def convert_payload_to_json(self, arg_req_dict: dict):
        ...
        logging.info("[Edge Data Service] Fusion Depth {0}".format(arg_req_dict["fusion_depth_index"]))
    ...
    def send_req_to_event_manager(self, arg_req_dict: dict):
        ...
        bootstrap_servers = ['10.16.70.247:9092']
        topic_name = 'fusion'
...
if __name__ == "__main__":
    ...
    print("[Edge Data Service] Service started send requests to tcp://{0}:12000".format(local_ip_address))
    ...
    data_service_record_file = open("text_inferencing_edge_gcp_record_file.txt", "a")
    ...
    while True:
        ...
        if ("data_op_type" in request_dict) and (request_dict["data_op_type"] == "put"):
            ...
            record_dict = {"start_time": start_time, "end_time": end_time, "total_time": total_time,
                           ...
                           "sending_function": request_dict["sending_function"], "layer": "raspberry"}
            logging.info("[Edge Data Service] put {0}".format(record_dict))
            ...
            record_dict = {"start_time": start_time, "end_time": end_time, "total_time": total_time,
                           ...
                           "sending_function": "init_put_client", "layer": "raspberry"}
            data_service_record_file.write(json.dumps(record_dict))
            data_service_record_file.write("\n")
            data_service_record_file.flush()
